...
def plotting(data):
    ...
    motor_dataL["velocity"].append(abs(float(data_list[0])))
    motor_dataL["voltage"].append(abs(float(data_list[1])))
    motor_dataL["temperature"].append(abs(float(data_list[2])))
    motor_dataL["current"].append(abs(float(data_list[3])))
    motor_dataR["velocity"].append(abs(float(data_list[4])))
